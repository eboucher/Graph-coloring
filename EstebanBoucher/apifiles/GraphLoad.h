...
/*
 * Define a hashing method to compute the hash code for the key of the data
 * item.
 */
 ...
 * passed and locate the actual element index using that hash code as index
...
/*
 * Whenever an edge is to be inserted. Call find_vertex_hash for each vertex
 * to make sure both have assigned cells in G->name_array. Then add each other
